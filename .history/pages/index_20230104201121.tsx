  ...
  */
  ...
  return (
    <div>
      ...
      <div>
        <PrimarySearchAppBar createHandler={createHandler}  searchQuery={searchQuery} hasSession={hasSession} setSession={setSession} handleSignUp={handleSignUhandleSignUpp}/>
