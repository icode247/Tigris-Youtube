...
export default function Player() {
    ...
    return (
        <>
            <PrimarySearchAppBar createHandler={createHandler} searchQuery={createHandler} hasSession={false} setSession={setSession} handleSignIn={createHandler} handleSignUp={createHandler} fetchStatus={}/>
            <Container>
                <div>
