...
export default function Player() {
    ...
    const [session, setSession] = useState(bo)
    ...
    return (
        <>
            <PrimarySearchAppBar createHandler={createHandler} searchQuery={createHandler} hasSession={true} setSession={} handleSignIn={} handleSignUp={}/>
            <Container>
                <div>
