...
export default function Player() {
    ...
    return (
        <>
            <PrimarySearchAppBar createHandler={createHandler} searchQuery={createHandler} hasSession={true} setSession={setSession} handleSignIn={createHandler} handleSignUp={c}/>
            <Container>
                <div>
