...
export default function Account({ handleSignUp, hamdleSignin }: Props) {
    ...
    return (
        <Box sx={style} component="form">
            ...
            <Button variant="outlined" onClick={() => !isLogin ? handleSignUp(name, email, password) : ''}>{isLogin ? "Login" : "Signup"}</Button>
