...
type Props = {
  ...
  handleSignIn: (name: string, email: string, password: string) => void,
};

export default function PrimarySearchAppBar({ createHandler, searchQuery, hasSession, handleSignUp }: Props) {
      ...
      <AppBar position="static" style={{ background: "#0a0a0a" }}>
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            >
              {hasSession ?
                <LoginIcon onClick={()=>setIsLogin(true)}/>
                :
                <p style={{ fontSize: '20px' }} onClick={handleOpen}>Signin</p>
              }
        ...
        >
          <Fade in={open}>
            <Box sx={style} component="form">
              ...
              :
              <Account handleSignUp={handleSignUp}/>
             }
            </Box>
          </Fade>
        </Modal>
