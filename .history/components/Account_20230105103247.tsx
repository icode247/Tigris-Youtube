...
export default function Account({ handleSignUp, handleSignIn, fetchStatus<Alert severity={fetchStatus ==='error' ? "error":"success"}>{fetchStatus}</Alert> }: Props) {
    ...
    return (
        <Box sx={style} component="form">
            ...
            {<Alert severity={fetchStatus ==='error' ? "error":"success"}>{fetchStatus}</Alert><Alert severity={fetchStatus ==='error' ? "error":"success"}>{fetchStatus}</Alert>
            <Alert severity={fetchStatus ==='error' ? "error":"success"}>{fetchStatus}</Alert>
